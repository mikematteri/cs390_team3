module.exports = {
	...
	url : 'mongodb://localhost:27017/comciergedb',
	
	recommender : function (db, callback)
	{
	...
	compareUsers : function (db, callback)
	{
		//TODO
	...
	toggleFavorite : function (db, callback) //(db, user, comic, callback)
	{
		//TODO
		...
		/*
		var cursor = db.collection('comics').find({comicName: "Three Panel Soul"});
		//var targetUser = db.collection('users').find({userName: user});
		
		var targetDoc = cursor.next();
		...
		*/
		...
		console.log("exiting toggleFavorite");
	...
	addRating : function (db, callback)
	{
		//TODO
	...
	//export {recommender, compareUsers, toggleFavorite, addTag, addRating};
